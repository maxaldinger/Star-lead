...
export async function POST(req: Request) {
  ...
  try {
    const msg = await client.messages.create({
      ...
      messages: [{
        role: 'user',
        content: `You are an elite enterprise sales strategist specializing in MEDDPICC methodology, selling Stardog -- a knowledge graph and data unification platform.
...

{
  ...
  "lou": "A draft Letter of Understanding (2-3 paragraphs). Summarize what you heard: the customer's pain, what they need, what success looks like, and proposed next steps. Frame around Stardog's value: data unification, knowledge graphs, grounded AI. Write as if sending to the champion after the call.",
  "threading": [
...
- Frame everything through Stardog's lens: knowledge graphs, virtual data federation, AI grounding, Voicebox.
